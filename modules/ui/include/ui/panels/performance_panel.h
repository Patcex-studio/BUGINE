...
namespace rendering_engine { class RenderingEngine; }
...
private:
    rendering_engine::RenderingEngine* renderingEngine_ = nullptr;
    std::vector<float> frameTimeHistory_;   // ring buffer for 300 values
